...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/PuzzleAction.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        ...
        {
            ""name"": ""UI"",
            ""id"": ""7b9a8d9b-bb4e-472e-ba88-07b9adb49fab"",
            ""actions"": [
                {
                    ""name"": ""Cancel"",
                    ""type"": ""Button"",
                    ""id"": ""80b086b1-1ca1-4262-b05c-78c23489ab36"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""0dd8f909-a5cc-4c57-b161-08bd0de25ef8"",
    ...
    ""controlSchemes"": []
        ...
        ~@PuzzleControl()
        {
            ...
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PuzzleControl.UI.Disable() has not been called.");
        }
        ...
        public struct PuzzleActions
        {
            ...
            /// <summary>
            /// Provides access to the underlying input action "Puzzle/Press".
            /// </summary>
            public InputAction @Press => m_Wrapper.m_Puzzle_Press;
            /// <summary>
            /// Provides access to the underlying input action "Puzzle/Position".
            /// </summary>
        ...
        public struct UIActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public UIActions(@PuzzleControl wrapper) { m_Wrapper = wrapper; }
            /// <summary>
